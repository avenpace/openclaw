...
import { defaultTitle, formatDetailKey, normalizeToolName, normalizeVerb, resolveActionSpec, resolveDetailFromKeys, resolveExecDetail, resolveReadDetail, resolveWebFetchDetail, resolveWebSearchDetail, resolveWriteDetail, } from "./tool-display-common.js";
...
export function resolveToolDisplay(params) {
    ...
    const fallbackVerb = key === "web_search"
        ? "search"
        : key === "web_fetch"
            ? "fetch"
