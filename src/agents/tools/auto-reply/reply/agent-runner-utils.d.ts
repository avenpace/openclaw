...
export declare function buildEmbeddedRunBaseParams(params: {
    ...
    thinkLevel: import("./directives.js").ThinkLevel;
    verboseLevel: import("./directives.js").VerboseLevel;
    reasoningLevel: import("./directives.js").ReasoningLevel;
    execOverrides: Pick<import("../../agents/bash-tools.exec.js").ExecToolDefaults, "node" | "security" | "ask" | "host">;
    bashElevated: {
        enabled: boolean;
        allowed: boolean;
    ...
    skillsSnapshot: import("../../agents/skills.js").SkillSnapshot;
    ownerNumbers: string[];
