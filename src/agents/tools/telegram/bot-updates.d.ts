...
export declare const resolveTelegramUpdateId: (ctx: TelegramUpdateKeyContext) => number;
export declare const buildTelegramUpdateKey: (ctx: TelegramUpdateKeyContext) => string;
