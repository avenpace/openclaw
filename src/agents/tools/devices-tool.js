 ...
 */
export function createDevicesListTool(handler) {
    return {
        label: "List Devices",
        name: "devices_list",
 ...
 */
export function createDevicesRunTool(handler) {
    return {
        label: "Run on Device",
        name: "devices_run",
 ...
 */
export function createDevicesJobStatusTool(handler) {
    return {
 ...
 */
export function createDevicesUploadTool(handler) {
    return {
 ...
 */
export function createDevicesSendFileTool(handler) {
 ...
 */
export function createDevicesFindAndSendTool(handler) {
 ...
 */
export function createDevicesTools(handler) {
    const tools = [
...
//# sourceMappingURL=devices-tool.js.map