 ...
 */
export function createCloudStorageInfoTool(handler) {
    return {
 ...
 */
export function createCloudListFilesTool(handler) {
    return {
 ...
 */
export function createCloudListFoldersTool(handler) {
    return {
 ...
 */
export function createCloudGetFileTool(handler) {
    return {
 ...
 */
export function createCloudReadFileTool(handler) {
    return {
 ...
 */
export function createCloudUploadTool(handler) {
    return {
...
export function createCloudUploadBase64Tool(handler) {
    return {
...
export function createCloudExtractTextTool(handler) {
    return {
...
export function createCloudCreateDocumentTool(handler) {
    return {
 ...
 */
export function createCloudDeleteFileTool(handler) {
    return {
 ...
 */
export function createCloudUpdateFileTool(handler) {
    return {
 ...
 */
export function createCloudCreateFolderTool(handler) {
    return {
 ...
 */
export function createCloudDeleteFolderTool(handler) {
    return {
 ...
 */
export function createCloudShareFileTool(handler) {
    return {
 ...
 */
export function createCloudStorageTools(handler) {
    return [
...
//# sourceMappingURL=cloud-storage-tool.js.map
