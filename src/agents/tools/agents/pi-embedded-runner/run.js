...
import { isProfileInCooldown, markAuthProfileFailure, markAuthProfileGood, markAuthProfileUsed, resolveProfilesUnavailableReason, } from "../auth-profiles.js";
    ...
    return enqueueSession(() => enqueueGlobal(async () => {
        ...
        const resolveAuthProfileFailoverReason = (params) => {
            if (params.allInCooldown) {
                const profileIds = (params.profileIds ?? profileCandidates).filter((id) => typeof id === "string" && id.length > 0);
