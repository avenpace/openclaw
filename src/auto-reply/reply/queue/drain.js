        ...
        try {
            ...
            while (queue.items.length > 0 || queue.droppedCount > 0) {
                ...
                if (queue.mode === "collect") {
                    ...
                    const originatingThreadId = items.find((i) => i.originatingThreadId != null && i.originatingThreadId !== "")?.originatingThreadId;
                ...
                if (summaryPrompt) {
                    ...
                    if (!(await drainNextQueueItem(queue.items, async () => {
                        await runFollowup({
