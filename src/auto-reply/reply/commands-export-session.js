...
export async function buildExportSessionReply(params) {
    ...
    let sessionFile;
    try {
        sessionFile = resolveSessionFilePath(entry.sessionId, entry, resolveSessionFilePathOptions({ agentId: params.agentId, storePath }));
    }
    catch (err) {
        return {
...
//# sourceMappingURL=commands-export-session.js.map