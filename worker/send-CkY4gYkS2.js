...
import {
  Ai as isAllowedParsedChatSender,
  Di as resolveIMessageAccount,
  r as loadConfig,
  uc as kindFromMime,
} from "./config-Cz7eAoWC.js";
import { s as resolveMarkdownTableMode } from "./ir-DUSE-mNJ.js";
import { t as resolveOutboundAttachmentFromUrl } from "./outbound-attachment-DFCIKn8a.js";
import { t as convertMarkdownTables } from "./tables-D0-JLGfw.js";
import { d as normalizeE164, h as resolveUserPath } from "./utils-DAQkyZZs.js";
  ...
  async start() {
    ...
    child.on("close", (code, signal) => {
      if (code !== 0 && code !== null) {
        ...
        this.failAll(/* @__PURE__ */ new Error("imsg rpc closed"));
      }
      this.closedResolve?.();
    });
  }
...
//#endregion
export {
  isAllowedIMessageSender as a,
  formatIMessageChatTarget as i,
  createIMessageRpcClient as n,
  normalizeIMessageHandle as o,
  DEFAULT_IMESSAGE_PROBE_TIMEOUT_MS as r,
  parseIMessageTarget as s,
  sendMessageIMessage as t,
};
