...
import {
  ...
  Vi as resolveAccountEntry,
  ac as extensionForMime,
  da as resizeToJpeg,
  ic as detectMime,
  la as hasAlphaChannel,
  pc as maxBytesForKind,
  sa as convertHeicToJpeg,
  ua as optimizeImageToPng,
  uc as kindFromMime,
} from "./config-Cz7eAoWC.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia } from "./fetch-DKMnlEva.js";
import {
  Ot as SafeOpenError,
  Pt as readLocalFileSafely,
  vt as normalizeAccountId,
} from "./paths-Cp7C2R7V.js";
import { B as shouldLogVerbose, R as logVerbose, h as resolveUserPath } from "./utils-DAQkyZZs.js";
...
function chunkMarkdownIR(ir, limit) {
  ...
  chunks.forEach((chunk, index) => {
    ...
    if (index > 0) {
      while (cursor < ir.text.length && /\s/.test(ir.text[cursor] ?? "")) cursor += 1;
    }
    const start = cursor;
...
//#endregion
export {
  isSafeFenceBreak as _,
  loadWebMedia as a,
  chunkByNewline as c,
  chunkMarkdownTextWithMode as d,
  chunkText as f,
  findFenceSpanAt as g,
  resolveTextChunkLimit as h,
  getDefaultLocalRoots as i,
  chunkByParagraph as l,
  resolveChunkMode as m,
  markdownToIR as n,
  loadWebMediaRaw as o,
  chunkTextWithMode as p,
  markdownToIRWithMeta as r,
  resolveMarkdownTableMode as s,
  chunkMarkdownIR as t,
  chunkMarkdownText as u,
  parseFenceSpans as v,
};
