import { St as resolveTelegramPreviewStreamMode, hn as withFileLock$1, i as readConfigFileSnapshotForWrite, n as loadConfig, o as writeConfigFile } from "./config-5NZVrebk.js";
import { B as safeParseJson, Q as logVerbose, T as CONFIG_DIR, X as danger, t as createSubsystemLogger } from "./subsystem-CZjf--pX.js";
...
import { i as recordChannelActivity, n as createTelegramRetryRunner } from "./retry-policy-DhgTzIIo.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-D0tvLkR5.js";
import { t as isTruthyEnvValue } from "./env-Cm5puq-Z.js";
import { f as DEFAULT_ACCOUNT_ID, p as normalizeAccountId } from "./session-key-DRugVm48.js";
import { l as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-sjvd3vNx.js";
import { t as redactSensitiveText } from "./redact-Yttj_y9u.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-pWR6MKpJ.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-DeTFJD1T.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-B8YplKEr.js";
import { t as renderMarkdownWithMarkers } from "./render-B1VqYyvo.js";
import { t as resolveFetch } from "./fetch-CK8zxhsg.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-B-jzEvsx.js";
import { n as normalizePollInput } from "./polls-CgC7zuPk.js";
import { t as makeProxyFetch } from "./proxy-DWIqlsDF.js";
...
//#endregion
export { readJsonFileWithFallback as $, hasBotMention as A, normalizeDmAllowFromWithStore as B, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramReplyId as F, firstDefined as G, isVoiceCompatibleAudio as H, resolveTelegramStreamMode as I, resolveGroupAllowFromSources as J, isSenderIdAllowed as K, resolveTelegramThreadSpec as L, resolveTelegramForumThreadId as M, resolveTelegramGroupAllowFromContext as N, expandTextLinks as O, resolveTelegramMediaPlaceholder as P, upsertChannelPairingRequest as Q, isSenderAllowed as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, parseTelegramTarget as U, resolveSenderAllowMatch as V, resolveTelegramTargetChatType as W, readChannelAllowFromStore as X, addChannelAllowFromStoreEntry as Y, removeChannelAllowFromStoreEntry as Z, splitTelegramCaption as _, reactMessageTelegram as a, buildSenderLabel as b, sendStickerTelegram as c, isRecoverableTelegramNetworkError as d, writeJsonFileAtomically as et, markdownToTelegramChunks as f, resolveTelegramFetch as g, wrapFileReferencesInHtml as h, editMessageTelegram as i, toLocationContext as it, normalizeForwardedContext as j, extractTelegramLocation as k, resolveTelegramVoiceSend as l, renderTelegramHtmlText as m, createForumTopicTelegram as n, listPairingChannels as nt, sendMessageTelegram as o, markdownToTelegramHtml as p, mergeDmAllowFromSources as q, deleteMessageTelegram as r, formatLocationText as rt, sendPollTelegram as s, buildInlineKeyboard as t, getPairingAdapter as tt, wasSentByBot as u, withTelegramApiErrorLogging as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, normalizeAllowFrom as z };