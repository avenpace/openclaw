import { r as loadConfig } from "./config-Cz7eAoWC.js";
...
function loadCommandPollBackoffRuntime() {
  commandPollBackoffRuntimePromise ??= import("./command-poll-backoff.runtime-BMJ6MGXV.js");
...
function startDiagnosticHeartbeat(config) {
  ...
  heartbeatInterval = setInterval(() => {
    ...
    if (now - lastActivityAt > 12e4 && activeCount === 0 && waitingCount === 0) {
      return;
    }
    diag.debug(
