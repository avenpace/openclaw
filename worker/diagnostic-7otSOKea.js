import { Vn as __exportAll, n as loadConfig } from "./config-5NZVrebk.js";
import { t as createSubsystemLogger } from "./subsystem-CZjf--pX.js";
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-BrcMlBZ4.js";
...
function startDiagnosticHeartbeat(config) {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-Bo3L0KPE.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
