import { Mt as normalizeProviderId, Xt as requireApiKey, Zt as resolveApiKeyForProvider, d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, mn as resolveOpenClawAgentDir, n as loadConfig, p as mergeInboundPathRoots, zt as normalizeGoogleModelId } from "./config-5NZVrebk.js";
import { Q as logVerbose, ft as resolvePreferredOpenClawTmpDir, t as createSubsystemLogger, tt as shouldLogVerbose } from "./subsystem-CZjf--pX.js";
import { D as runExec, L as resolveAgentModelFallbackValues, R as resolveAgentModelPrimaryValue } from "./agent-scope-ScGrwqyV.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-D0tvLkR5.js";
import { t as normalizeChatType } from "./chat-type-DKb2TlGZ.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-CcjOMkEw.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-ET7IDSc0.js";
import { n as fetchWithTimeout } from "./fetch-timeout-gUsMwspm.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DFPItc0w.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-Ct_z9D74.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DHHx5lM1.js").then((n) => n.r);
