import { n as loadConfig, o as writeConfigFile, t as createConfigIO, v as getBlockedNetworkModeReason } from "./config-5NZVrebk.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-CZjf--pX.js";
import { a as resolveGatewayPort, n as STATE_DIR } from "./paths-DCNrSyZW.js";
import { D as runExec, H as resolvePathViaExistingAncestorSync, P as openBoundaryFile, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-ScGrwqyV.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-BLdY2C8K.js";
import { t as SsrFBlockedError } from "./ssrf-BuTqKYS4.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-D0tvLkR5.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-Dxq5cXiE.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-Cm5puq-Z.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-DRugVm48.js";
import { o as normalizeThinkLevel } from "./thinking-TjNtx91v.js";
import { U as canonicalizeMainSessionAlias, W as resolveAgentMainSessionKey, j as acquireSessionWriteLock } from "./sessions-B6xyLi77.js";
import { t as generateSecureToken } from "./secure-random-B2UrD2xa.js";
import { A as resolveExistingPathsWithinRoot, B as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, C as ensureChromeExtensionRelayServer, D as DEFAULT_DOWNLOAD_DIR, F as isLoopbackHost, H as DEFAULT_OPENCLAW_BROWSER_COLOR, L as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, M as resolveWritablePathWithinRoot, O as DEFAULT_TRACE_DIR, P as normalizeBrowserFormField, R as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, U as DEFAULT_OPENCLAW_BROWSER_ENABLED, V as DEFAULT_BROWSER_EVALUATE_ENABLED, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./chrome-jcVcRQ9G.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DdCpXfCI.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-pWR6MKpJ.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-DmmOkNHb.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-B7_cfAZg.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CDV0I--j.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) {try {
			await (await import("./pw-ai-CDV0I--j.js")).closePlaywrightBrowserConnection();
		} catch {}}
