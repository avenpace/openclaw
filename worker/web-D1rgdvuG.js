...
import { r as setActiveWebListener } from "./active-listener-ChCblYAT.js";
import { _ as registerUnhandledRejectionHandler } from "./audio-transcription-runner-CrDuQKDe.js";
...
} from "./paths-CbQMaT4w.js";
import { ct as toLocationContext } from "./send-DGdZl3lT.js";
import {
...
function resolveWorkerEntry() {
  ...
  if (entry.endsWith(".ts")) return { argv: ["--import", "tsx", entry] };
  return { argv: [entry] };
}
