...
import { p as getDiagnosticSessionState, s as logToolLoopAction } from "./diagnostic-BFc7FPX3.js";
import { C as isPlainObject, O as createSubsystemLogger } from "./utils-DAQkyZZs.js";
...
function hashToolOutcome(toolName, params, result, error) {
  ...
  if (!isPlainObject(result)) {
    return result === void 0 ? void 0 : digestStable(result);
  }
