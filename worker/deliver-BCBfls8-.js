...
import {
  ...
  Io as getActivePluginRegistryVersion,
  Jo as triggerInternalHook,
  Po as getActivePluginRegistry,
  Zr as getChannelPlugin,
  _n as isMessagingToolDuplicate,
  ei as getChannelDock,
  ir as resolveMirroredTranscriptText,
  jr as parseInlineDirectives,
  qo as createInternalHookEvent,
  rr as appendAssistantMessageToSessionTranscript,
  xa as generateSecureUuid,
} from "./config-DU_NmThJ.js";
import { i as getAgentScopedMediaLocalRoots } from "./fetch-BOzzKyEg.js";
import {
  d as chunkMarkdownTextWithMode,
  h as resolveTextChunkLimit,
  l as chunkByParagraph,
  m as resolveChunkMode,
  s as resolveMarkdownTableMode,
  v as parseFenceSpans,
} from "./ir-BO9afMew.js";
import { vt as normalizeAccountId, yt as normalizeOptionalAccountId } from "./paths-CbQMaT4w.js";
import { c as resolveStateDir } from "./paths-WDBH9p6f.js";
import { c as markdownToSignalTextChunks, t as sendMessageSignal } from "./send-BKEM3QZX.js";
import { r as parseTelegramTarget } from "./targets-D4pwl9LR.js";
import { i as isSilentReplyText } from "./tokens-C8OT5B-B.js";
import { O as createSubsystemLogger, R as logVerbose } from "./utils-CGX1uqdh.js";
    ...
    for (const hook of hooks)
      try {
        ...
        if (handlerResult !== void 0 && handlerResult !== null)
          if (mergeResults && result !== void 0) result = mergeResults(result, handlerResult);
...
function createReplyToModeFilterForChannel(mode, channel) {
  const provider = normalizeChannelId(channel);
  const isWebchat =
    (typeof channel === "string" ? channel.trim().toLowerCase() : void 0) === "webchat";
...
function targetsMatchForSuppression(params) {
  ...
  const targetThreadId =
    normalizeThreadIdForComparison(params.targetThreadId) ??
    (target.messageThreadId != null ? String(target.messageThreadId) : void 0);
...
async function deliverOutboundPayloadsCore(params) {
  ...
  const sendSignalTextChunks = async (text) => {
    ...
    let signalChunks =
      textLimit === void 0
        ? markdownToSignalTextChunks(text, Number.POSITIVE_INFINITY, { tableMode: signalTableMode })
...
//#endregion
export {
  fireAndForgetHook as A,
  toInternalMessagePreprocessedContext as C,
  toPluginMessageContext as D,
  toInternalMessageTranscribedContext as E,
  initializeGlobalHookRunner as M,
  joinPresentTextSegments as N,
  toPluginMessageReceivedEvent as O,
  deriveInboundMessageHookContext as S,
  toInternalMessageSentContext as T,
  resolveReplyToMode as _,
  normalizeReplyPayloadsForDelivery as a,
  normalizeTargetForProvider as b,
  splitMediaFromOutput as c,
  filterMessagingToolDuplicates as d,
  filterMessagingToolMediaDuplicates as f,
  createReplyToModeFilterForChannel as g,
  shouldSuppressReasoningPayload as h,
  normalizeOutboundPayloadsForJson as i,
  getGlobalHookRunner as j,
  toPluginMessageSentEvent as k,
  applyReplyTagsToPayload as l,
  shouldSuppressMessagingToolReplies as m,
  formatOutboundPayloadLog as n,
  throwIfAborted as o,
  isRenderablePayload as p,
  normalizeOutboundPayloads as r,
  parseReplyDirectives as s,
  deliverOutboundPayloads as t,
  applyReplyThreading as u,
  buildTargetResolverSignature as v,
  toInternalMessageReceivedContext as w,
  buildCanonicalSentMessageHookContext as x,
  normalizeChannelTargetInput as y,
};
