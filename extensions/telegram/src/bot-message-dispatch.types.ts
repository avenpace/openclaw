...
export type DispatchTelegramMessageParams = {
  ...
  /** Clawku: persona-specific reply resolver (platform routes channel messages to personas). */
  replyResolver?: typeof import("openclaw/plugin-sdk/reply-runtime").getReplyFromConfig;
